...
plot(landapol,Cp1,'-ok','Markerfacecolor','k');
hold on;
grid on;
 legend('R=50000','R=100000','R=150000','R=200000','R=250000')
 xlabel('Tip speed ratio')
 ylabel('power coefficient')
title('power curve for E780')
